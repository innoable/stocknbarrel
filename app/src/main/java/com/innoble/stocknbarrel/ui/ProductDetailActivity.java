...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.content,new ProductAddFragment())
                .commit();
    ...
    public static class ProductAddFragment extends android.support.v4.app.Fragment{
        private Intent thisIntent;
        private TextView prodNameTxt;
        private TextView retailerTxt;
        private TextView totalCostTxt;
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            final EditText qtyEdit  = (EditText)view.findViewById(R.id.qtyEditText);
            ...
            Button addToCart = (Button)view.findViewById(R.id.add_to_cart_btn);
